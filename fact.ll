...
define i32 @fact(i32 %n) local_unnamed_addr #0 {
entry:
  br label %do.body

do.body:                                          ; preds = %do.body, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %do.body ]
  %f.0 = phi i32 [ 1, %entry ], [ %mul, %do.body ]
  %mul = mul nsw i32 %f.0, %i.0
...
entry:
  %call = tail call i32 @fact(i32 5)
  %call1 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32 %call)
  ret i32 0
}
